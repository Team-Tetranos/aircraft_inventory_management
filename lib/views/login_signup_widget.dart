...
class MyLogInText extends StatelessWidget {
  ...
  Color color;
  String fontfamily;
   MyLogInText({Key? key,required this.fontWeight,required this.text,required this.color,required this.fontsize,required this.fontfamily}) : super(key: key);
