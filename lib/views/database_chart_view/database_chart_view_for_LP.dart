...
import 'package:aircraft_inventory_management/views/database_chart_view/paginated_table_for_LP.dart';
import 'package:flutter/material.dart';

import '../../utils/routes/route_names.dart';

class DataBase_Chart_View_For_LP extends StatefulWidget {
  const DataBase_Chart_View_For_LP({Key? key}) : super(key: key);

  @override

  State<DataBase_Chart_View_For_LP> createState() => _DataBase_Chart_View_For_LPState();
}

class _DataBase_Chart_View_For_LPState extends State<DataBase_Chart_View_For_LP> {
  @override
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          ElevatedButton(onPressed: (){
                            Navigator.pushNamed(context, RouteNames.adddatachartLP);
