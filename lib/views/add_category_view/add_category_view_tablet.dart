...
class AddCategoryForTablet extends StatefulWidget {
  const AddCategoryForTablet({Key? key}) : super(key: key);

  @override
  State<AddCategoryForTablet> createState() => _AddCategoryForTabletState();
}

class _AddCategoryForTabletState extends State<AddCategoryForTablet> {
  @override
